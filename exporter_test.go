...
func TestE2E_HappyPath_AllMetrics(t *testing.T) {
	...
	workerHeartbeatMetrics := []string{
		`rspecq_worker_heartbeat_timestamp{build_id="e2e-test-build",worker_id="worker-1"}`,
		`rspecq_worker_heartbeat_timestamp{build_id="e2e-test-build",worker_id="worker-2"}`,
		`rspecq_worker_heartbeat_timestamp{build_id="e2e-test-build",worker_id="worker-3"}`,
	}
	...
	withdrawnMetrics := []string{
		`rspecq_workers_withdrawn{build_id="e2e-test-build",worker_id="worker-4"}`,
		`rspecq_workers_withdrawn{build_id="e2e-test-build",worker_id="worker-5"}`,
	}
